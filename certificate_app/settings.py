"""
Django settings for certificate_app project.
...
SECRET_KEY = 'django-insecure-#s88call)+nw8cy%@a7h$!1%%roe&#n@iu$8#jucs%i3gy_+3s'
...
WSGI_APPLICATION = 'certificate_app.wsgi.application'
